...
const mock = {
  products: [
    {
      type: '신입 Entry',
      description: '대학생 또는 신입이신가요? 해외에서 정착할 수 있는 효과적인 방법은 무엇일까요? 가까운 미래의 해외취업 기회를 잡기 위한 직무 & 비자 전략을 짜봐요.',
      link: 'entry',
      color: 'salmon',
      secondary: '#fb9f94',
      programs: [
        {
          title: "해외취업 101",
          code: '101',
          content: '해외취업 입문자를 위한 프로그램 입니다. 내가 가진 강점과 배경을 이용해서 어떻게 가장 빨리 내가 원하는 곳에 갈 수 있는지 단계별 전략을 모색합니다. 지금 나의 상황에서 가장 적합한 비자 프로그램은 무엇일까요? 워킹홀리데이를 준비할까요? 외국으로 바로 취업할 수 있을까요? 한국에서 경력을 먼저 쌓아야 할까요? 가까운 미래의 해외취업 기회를 잡기 위한 전체적인 전략짜기 프로그램입니다.',
      ...
      programs: [
        {
          title: "해외취업 201",
          code: '201',
          content: "경력직 해외취업 입문자를 위한 프로그램입니다. 세계 무대에서도 통하는 이력서는 어떻게 써야할까요? 어떻게 하면 인터뷰에서 자신이 가진 강점을 모두 어필할 수 있을까요? 한국에서 쌓아온 소중한 경력을 알차게 풀어내서 해외 구직 시장에서도 강력한 지원자가 될 수 있도록 도와드릴게요. 오랜 영어강사 내공을 바탕으로 멘토링을 진행합니다.",
          afters: ['최선의 비자 프로그램', '나의 경험 멋지게 스토리 만들기', '고급 회화', '해외공략 이력서', '링크드인 최적화', '콜드메세지 노하우', '현실성 있는 계획', '연봉 협상 노하우'],
          details: [
            {
              label: 'Who',
      ...
      programs: [
        {
          title: "영어 모의 인터뷰",
          code: '202',
          content: "해외취업 성공의 마지막 관문인 인터뷰를 위한 모의 인터뷰 프로그램 입니다. 세계 무대에서도 통하는 나의 강점을 무엇일까요? 중요한 것은 원어민처럼 완벽하게 말하는게 아니라 내가 가지고 있는 강점을 설득력 있게 말하는 것 입니다. 어떻게 표현해야 나의 경력을 직무와 엮어서 풀어낼 수 있을까요? 어떻게 하면 당황하지 않고 나의 강점을 답변 속에 녹여낼 수 있을까요? 주어진 시간 안에 주어진 질문의 범위 내에서 자신을 어필하는 방법을 연습합니다. 오랜 영어강사 내공을 바탕으로 멘토링을 진행합니다.",
          afters: ['실전같은 모의인터뷰', '설득력 있는 답변 구조', '고급 회화', '나의 경험 멋지게 스토리 만들기', '자주 출제되는 인성질문 리스트', '질문의 의도 파악 스킬', '연봉 협상 노하우'],
          details: [
            {
              label: 'Who',
    ...
    },
    {
      ...
      },
      {
        ...
        afters: ['기술직 이력서 최적화', '포트폴리오 피드백', '나에게 알맞은 회사 찾기', '기술면접을 위한 무료플랫폼 활용법', '모의 기술면접', '페어 프로그래밍', '모의 인성면접', '자주 출제되는 질문', '연봉 협상 노하우', '취직'],
        details: [
          {
            label: 'Who',
            value: '주니어 개발자 지원자'
      ...
      programs: [
        {
          title: "개발자 해외이직하기",
          code: '101',
          content: "현직 개발자의 해외 이직을 위한 프로그램입니다. 해외이직을 꿈꾸지만 준비가 막막하신가요? 해외 시장에서 선호하는 개발자의 역량과 성향은 무엇일까요? 지금까지 쌓아온 소중한 개발 경력을 어떻게 어필할 수 있을까요? 인터뷰에서 당락을 결정하는 Culture fit 준비부터 마지막의 연봉 협상 노하우까지 하나의 프로그램으로 모두 준비합니다. 현직 개발자가 100회 이상의 인터뷰 경험을 바탕으로 코칭합니다.",
          afters: ['비자전략', '해외공략 이력서', '해외시장별 공략 방법', '콜드 메세지 전략', '연봉 정보', '실전같은 모의 면접', '자주 출제되는 질문', 'Culture fit 면접 준비', '인터뷰 질문 의도 파악 팁', '연봉 협상 노하우', '해외이직'],
          details: [
            {
              label: 'Who',
      ...
      programs: [
        {
          title: "프론트엔드 인터뷰",
          code: '401',
          content: "실전과 같은 환경에서 기술 면접 연습이 필요하신가요? 시니어 프론트엔드 개발자와 함께 진행하는 프론트엔드 기술 면접 프로그램입니다. 실전과 같은 환경에서 페어 프로그래밍을 진행합니다. 자주 나오는 질문리스트를 기반으로 구술로 풀어내야하는 기술 면접 노하우를 멘토링합니다. 면접 답변 속에서 엔지니어로서 자신을 어필할 수 있는 방법을 알려 드릴게요. 현직 개발자가 100회 이상의 면접 경험을 바탕으로 코칭합니다. *프론트엔드 모의 인터뷰는 React, React Native, Vanilla Javascript 으로만 진행합니다.* ",
          afters: ['구술기술 면접', '압박면접 연습', '페어 프로그래밍', '인성면접', '산업별 특징', '프론트엔드 단골 질문', 'Javascript 단골 질문', 'React 단골 질문', 'React Native 단골 질문', '질문자 의도 파악 스킬', '연봉 협상 노하우'],
          details: [
            {
              label: 'Who',
              value: '프론트엔드 직무 구직자'
      ...
      programs: [
        {
          ...
          afters: ['심리학', '비전공 개발', '해외 개발자', '해외취업', '영국취업', '해외인턴', '스페인', '디지털노마드', '영어인터뷰', '토플', '스페인', '워킹홀리데이', '세계여행', '국제연애',],
          details: [
            {
              label: 'Who',
              value: '누구나'
  ...
  reviews: {
    ...
    },
    {
      ...
      program: ['해외취업 201'],
      content: '"독일에서 대학교를 졸업하고 한국으로 와서 취업을 했어요. 한국에서 좋은 기업에 취직했지만 유럽 생활이 그립기도 하고 한번쯤은 유럽에서 일 해보고 싶다는 생각을 했어요. 지금까지 경력을 쌓아온 직무나 업계가 사실 맘에 들고 사회초년생이 아니라서 여태까지 쌓아온 경력을 포기하고 싶지는 않았어요. 코칭을 받는 동안 현재의 직무경력을 살릴 수 있는 방향성을 지킬 수 있게 도와주셨고 최악의 상황을 대비해 유럽의 구직시장에서 기회를 얻는 데 도움이 되는 유럽의 단기 대학원 프로그램도 소개해주셨어요. 무조건 취업이 바로 될거라고 말씀하시기 보다는 목적을 이룰 수 있는 모든 방법을 함께 고민해주셨어요. 그런 다른 전략들이 해외취업 실패가 아니라 내가 가고 싶은 곳으로 가기 위해 멀어 보이지만 더 오히려 빠른 길일 수도 있다고 말씀해주셨습니다. 프로그램 중에서 이전까지는 계정만 있었던 링크드인을 효과적으로 활용하는 방법이 저에게 큰 도움이 되었습니다. 콜드 메세지로 시작된 대화가 결국 독일시장 취업의 결정적인 기회가 되었습니다. 경력직으로 들어가는 만큼 연봉 수준도 잘 조정해서 가고 싶었는데 프로그램에서 연봉 현상 노하우도 코칭해주셔서 너무 좋았어요. 헤더님의 현실적이면서도 따뜻한 조언 덕분에 끝까지 포기하지 않고 독일로 돌아갈 수 있게 되서 기뻐요."',
    },
    {
      color: '#0d78c7',
      name: '김동현',
