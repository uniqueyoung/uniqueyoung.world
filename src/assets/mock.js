      ...
      programs: [
        {
          title: "개발자 해외이직하기",
          code: '101',
          content: "현직 개발자의 해외 이직을 위한 프로그램입니다. 해외이직을 꿈꾸지만 준비가 막막하신가요? 해외 시장에서 선호하는 개발자의 역량과 성향은 무엇일까요? 지금까지 쌓아온 소중한 개발 경력을 어떻게 어필할 수 있을까요? 인터뷰에서 당락을 결정하는 Culture fit 준비부터 마지막의 연봉협상 노하우까지 하나의 프로그램으로 모두 준비합니다. 현직 개발자가 100회 이상의 인터뷰 경험을 바탕으로 코칭합니다.",
      ...
      programs: [
        {
          ...
          afters: ['구술기술 면접', '압박면접 연습', '페어 프로그래밍', '인성면접', '산업별 특징', '프론트엔드 단골 질문', 'Javascript 단골 질문', 'React 단골 질문', 'React Native 단골 질문', '질문자 의도 파악 스킬', '연봉협상 노하우'],
          details: [
            {
              label: 'Who',
              value: '프론트엔드 직무 구직자'
