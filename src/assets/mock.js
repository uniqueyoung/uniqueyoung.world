      ...
      programs: [
        {
          title: "해외취업 101",
          code: '101',
          content: '해외 취업 입문자를 위한 프로그램 입니다. 내가 가진 강점과 배경을 이용해서 어떻게 가장 빨리 내가 원하는 곳에 갈 수 있는지 단계별 전략을 모색합니다. 지금 나의 상황에서 가장 적합한 비자 프로그램은 무엇일까요? 워킹홀리데이를 준비할까요? 외국으로 바로 취업할 수 있을까요? 한국에서 경력을 먼저 쌓아야 할까요? 가까운 미래의 해외 취업 기회를 잡기 위한 전체적인 전략짜기 프로그램입니다.',
      ...
      programs: [
        {
          title: "해외취업 201",
          code: '201',
          content: "경력직 해외 취업 입문자를 위한 프로그램입니다. 세계 무대에서도 통하는 이력서는 어떻게 써야할까요? 어떻게 하면 인터뷰에서 자신이 가진 강점을 모두 어필할 수 있을까요? 한국에서 쌓아온 소중한 경력을 알차게 풀어내서 해외 구직 시장에서도 강력한 지원자가 될 수 있도록 도와드릴게요. 오랜 영어강사 내공을 바탕으로 멘토링을 진행합니다.",
      ...
      programs: [
        {
          ...
          afters: ['비자전략', '해외공략 이력서', '해외시장별 공략 방법', '콜드 메세지 전략', '연봉 정보', '실전같은 모의 면접', '자주 출제되는 질문', 'Culture fit 면접 준비', '인터뷰 질문 의도 파악 팁', '연봉 협상 노하우', '해외 이직'],
          details: [
            {
              label: 'Who',
