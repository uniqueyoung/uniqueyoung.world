...
const mock = {
  products: [
    {
      type: '신입 Entry',
      description: '대학생, 경력 1년 이하의 신입이신가요? 해외에서 정착할 수 있는 효과적인 방법은 무엇일까요? 가까운 미래의 해외 취업 기회를 잡기 위한 직무 & 비자 전략을 짜봐요.',
      link: 'entry',
      color: 'salmon',
      secondary: '#fb9f94',
      programs: [
        {
          ...
          afters: ['전략적 직무찾기', '최선의 비자 프로그램', '나라별 정부 정책 이용하기', '세계무대에서 먹히는 강점찾기', '전세계 인턴쉽/구직기회 찾기 방법', '효과적인 콜드 메세지 보내기', '해외취업을 위한 로드맵', '링크드인 최적화'],
          details: [
            {
              label: 'Who',
              value: '대학생, 경력 1년 이하 신입, 직무변경을 원하는 경력직'
            },
            {
              label: 'Assignment',
      ...
      programs: [
        {
          ...
          code: '201',
          form: 'https://forms.gle/A7EMVXVzu6Uo2Tdk7',
          content: "경력자이면서 해외 취업 입문자들은 위한 프로그램입니다. 세계 무대에서도 통하는 이력서는 어떻게 써야할까요? 어떻게 하면 인터뷰에서 자신이 가진 강점을 모두 어필할 수 있을까요? 비즈니스 영어 강사 내공을 바탕으로 제가 쌓아온 유럽 및 해외 취업전략을 공유합니다. 한국 취업과 해외 취업은 준비 방법과 실전 전략이 다릅니다. 한국에서 쌓아온 소중한 경력을 알차게 풀어내서 해외 구직 시장에서도 강력한 지원자가 될 수 있도록 도와드릴게요. 부족한 점을 빠르게 채우고 강점은 최대한 어필하는 전략을 만들어요.",
          afters: ['최선의 비자 프로그램', '나의 경험 멋지게 스토리 만들기', '고급 회화', '해외공략 이력서 최적화', '해외 구직 시장의 이해', '세계 무대에서 먹히는 나만의 강점 발견', '링크드인 최적화', '효율적으로 기회를 찾는 방법', '효과적인 콜드메세지 방법', '현실성 있는 계획', '연봉 협상 방법'],
          details: [
            {
              label: 'Who',
    ...
    {
      type: '영어 인터뷰',
      description: '해외 취업의 문 턱에서 실전과 같은 인터뷰 연습이 필요하신가요? 비즈니스 영어 강사와 함께하는 실전같은 모의면접 통해서 꼼꼼하게 준비해요.',
      link: 'english',
      color: '#e1a73c',
      secondary: '#f5ba4e',
      programs: [
        {
          ...
          afters: ['실전같은 모의인터뷰', '자세한 피드백', '설득력 있는 답변 구조', '세계 무대에서 먹히는 나만의 강점 발견', '고급 회화', '나의 경험 멋지게 스토리 만들기', '자주 출제되는 인성질문 리스트', '질문의 의도 파악 스킬', '연봉 협상 방법'],
          details: [
            {
              label: 'Who',
      ...
      programs: [
        {
          ...
          code: '101',
          form: 'https://forms.gle/A7EMVXVzu6Uo2Tdk7',
          content: "현직 개발자의 해외 이직을 위한 프로그램입니다. 해외 이직을 꿈꾸지만 어떻게 준비해야 할지 막막하신가요? 해외 시장에서 선호하는 개발자의 역량과 성향은 무엇인가요? 어떻게 하면 제 실력을 어필할 수 있을까요? 저와 함께 이 프로그램을 통해서 지금까지 쌓아온 소중한 개발 경력을 뽐내봐요. 인터뷰에서 당락을 결정하는 Culture fit 준비부터 마지막의 연봉 협상 노하우까지 하나의 프로그램으로 모두 준비합니다. 현직 개발자가 100회 이상의 인터뷰 경험을 바탕으로 코칭합니다.",
          afters: ['가장 효율적인 비자 계획', '해외공략 개발자 이력서', '시장별 공략 방법', '콜드 메세지 전략', '연봉 정보', '실전같은 모의 면접', '자주 출제되는 질문', 'Culture fit 면접 준비', '인터뷰 질문 의도 파악 팁', '연봉 협상 방법', '해외 이직'],
          details: [
            {
              label: 'Who',
      ...
      programs: [
        {
          ...
          afters: ['구술기술 면접', '압박면접 연습', '페어 프로그래밍', '인성면접', '프론트엔드 업계별 특징', '프론트엔드 ultimate 단골 질문', 'Javascript 단골 질문', 'React 단골 질문', 'React Native 단골 질문', '질문자의 의도를 파악하는 방법', '연봉 협상 방법'],
          details: [
            {
              label: 'Who',
              value: '프론트엔드 직무 구직자'
  ...
  reviews: {
    ...
    },
    {
      ...
      content: '"저는 대기업에 재직 중인 30대 초반입니다. 저는 결혼하고 아기가 생기면서 개발로 이직을 하기로 결심한 후 지인의 소개로 헤더님을 알게 됬습니다. 궁금한 점도 많고 걱정도 많았는데 비전공자 개발자의 입장에서 현실적으로 어떤 부분이 힘든지 어떻게 해야 효율적으로 공부할 수 있는지 말씀해주셨고 연봉 수준이나 전망과 같은 저에게는 너무 중요한 정보도 알려주셨습니다. 저는 국비 지원 교육을 계획하고 있었는데 학원이랑 프로그램이 너무 많아서 어떤 것을 선택해야 할 지 고민하고 있었습니다. 그 부분에 대해서 취업에 유리한 언어는 무엇이고 요새 많이 쓰이는 언어나 프레임워크는 무엇인지 구체적으로 코칭 해주신 점이 도움이 많이 되었습니다. 개발자로 이직하기 101 프로그램을 듣고 굳이 국비지원 프로그램을 들을 필요가 없겠다고 결론을 내려 지금은 헤더님과 함께 만든 로드맵을 중심으로 독학하고 있습니다. 적지 않은 나이라고 생각해서 정말 많이 고민하고 망설였는데 헤더님이 알고 계시는 나이가 많은 개발자들, 컴퓨터 계열 전공이 아닌 개발자들 이야기를 많이 들으면서 저도 용기를 낼 수 있었습니다" ',
    },
    {
      color: '#2ba561',
      name: '양소영',
    ...
    },
    {
      ...
      program: ['개발자 해외이직하기'],
      content: '"한국 중소기업 스타트업에서 2년 정도 개발자로 일했어요. 다음 회사는 외국에서 다니고 싶어서 알아보던 중 지인의 지인을 통해서 헤더님을 알게됬습니다. 사실 별 기대 없이 링크드인 메세지를 보냈는데 답장을 정말 친절하고 자세하게 해주셨어요! 영어 점수는 꽤 높은 편이었지만 프리토킹은 자신이 없는게 항상 고민이었는데 헤더님이랑 이야기하고 이직에 대한 자신감이 조금씩 생기면서 이 프로그램을 듣기로 결정했어요. 저는 영국을 목표로 잡았는데 영국 시장에서 많이 쓰는 표현이나 프레임워크에 대해 구체적으로 알려주셨어요. 사실 한국에서 취직, 이직할 때랑 절차와 기준이 많이 달라서 이 프로그램을 듣지 않았으면 정말 시간 낭비 했을 것 같아요. 실전 인터뷰를 준비하는 과정에서도 코딩 테스트와 인성면접 꿀팁도 세세하게 알려주셔서 좋았습니다. 특히 자주 나오는 질문에 답변을 할 때 제 성격적인 장점과 엔지니어로서의 실력을 동시에 표현할 수 있는 방법도 배웠어요. 공격적으로 지원을 하긴 했지만 구직을 시작한 지 한달도 채 안되서 채용이 확정됐어요. 저처럼 늘 해외취업을 생각해왔지만 자신이 없어 실행에 옮기지 못한 분들에게 헤더님 프로그램을 적극 추천합니다!"',
    },
    {
      color: "#0066b2",
      name: '이문영',
